...
public class StatsCalculatorsRegistrar {
    ...
    private static void registerValidators(ServiceRegistry registry) {
    ...
    private static void registerPeriodicCalculators(ServiceRegistry registry) {
    ...
    private static void registerCumulativeCalculators(ServiceRegistry registry) {
