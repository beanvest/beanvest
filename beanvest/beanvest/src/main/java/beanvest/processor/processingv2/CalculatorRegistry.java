...
public class CalculatorRegistry {
    private final Map<String, Function<CalculatorRegistry, Object>> factories = new HashMap<>();
    private final Map<String, Object> instances = new HashMap<>();
    private final Set<ProcessorV2> processors = new HashSet<>();

    public <T> void register(Class<T> builtClass, Function<CalculatorRegistry, T> factory) {
        factories.put(builtClass.getName(), (Function<CalculatorRegistry, Object>) factory);
    }
